            ...
            <div class="md:col-span-3 bg-card border border-border rounded-2xl p-8">
                ...
                <form action="{{ route('contact.send') }}" method="POST" class="space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                   ...
                                   required>
                            @error('name')<p class="font-mono text-xs text-coral mt-1">{{ $message }}</p>@enderror
                        </div>
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email') }}"
                                   ...
                                   class="w-full bg-surface border border-border rounded-xl px-4 py-3 font-mono text-sm text-white placeholder-gray-600 focus:outline-none focus:border-accent transition-colors"
                                   required>
                            @error('email')<p class="font-mono text-xs text-coral mt-1">{{ $message }}</p>@enderror
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        @error('message')<p class="font-mono text-xs text-coral mt-1">{{ $message }}</p>@enderror
                    </div>
