...
<head>
    ...
    <title>@yield('title', 'Mon Portfolio — Développeur Full-Stack')</title>
    <meta name="description" content="@yield('meta_desc', 'Portfolio de développeur Full-Stack spécialisé Laravel, Vue.js, React.')">
...
<body class="relative z-10">
    ...
    <nav id="navbar" class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 py-6 px-6 md:px-16">
        <div class="max-w-6xl mx-auto flex items-center justify-between">
            <a href="{{ route('home') }}" class="font-display text-xl font-bold text-white tracking-tight">
    ...
    <footer class="border-t border-border py-10 px-6 md:px-16">
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500 font-mono">
            <p>© {{ date('Y') }} — Développeur Full-Stack. Fait avec <span class="text-coral">♥</span> & Laravel.</p>
