        ...
        <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            ...
            <div class="reveal order-2 md:order-1">
                <div class="relative w-fit mx-auto">
                    <div class="w-72 h-72 rounded-3xl bg-card border border-border flex items-center justify-center overflow-hidden relative">
                        <div class="absolute inset-0 opacity-20" style="background: linear-gradient(135deg, #7C3AED, #BFFF00);"></div>
                        <span class="font-display text-8xl font-black text-white relative z-10 opacity-30">BD</span>
                    </div>
                    <div class="absolute -bottom-4 -right-4 bg-card border border-border rounded-2xl px-5 py-4 font-mono text-center shadow-xl">
